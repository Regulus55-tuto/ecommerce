                            ...
                            <>
                                ...
                                <h3 className={'-my-3 flow-root'}>
                                    <Disclosure.Button className={'flex w-full items-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500'}>
                                        ...
                                        <span className={'ml-6 flex items-center'}>{name}
                                            {open ? (
                                                <MinusIcon/>
                                            ) : (
                                                <PlusIcon/>
                                ...
                                {/*filter body*/}
                                {name === 'Color' && (
                                    <ColorFilter colors={colors} setSortParams={setSortParams} deleteSortParams={deleteSortParams} params={searchParams.get('color')} searchParams={searchParams}/>
                                )}
                                {name === "Size" && (
                                  <SizeFilter sizes={sizes} setSortParams={setSortParams} deleteSortParams={deleteSortParams} params={searchParams.get('size')} searchParams={searchParams}/>
                                )}
                            </>
                        )}
                    </Disclosure>
