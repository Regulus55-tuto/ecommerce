import React, {Dispatch, forwardRef, Fragment, SetStateAction, useEffect, useState} from "react";
        ...
        return (
            <nav className={"relative bg-white"}>
                <div
                    aria-label="Top"
                    className={
                        "mx-auto max-w-7xl border-gray-200 bg-white px-4 sm:px-6 lg:px-8"
                    }
                >
                    <div className={"flex h-16 items-center"}>
                        ...
                        <div className={"ml-4 flex lg:ml-0"}>
                            <Link to={"/"} className={"flex items-center "}>
                                <FaShopify size={"40px"} color={"#8B5CF6"} className="mr-2"/>
                            </Link>
                        </div>

                        <Popover.Group
                            className={"z-50 hidden lg:ml-8 lg:block lg:self-stretch"}
                        >
                            <div className={"flex h-full space-x-8"}>
                                        ...
                                        {({open}: { open: boolean }) => (
                                            <>
                                                ...
                                                >
                                                    <Popover.Panel
                                                        className={
                                                            "absolute inset-x-0 top-full border-t-[1px] border-gray-200 text-sm text-gray-500"
                                                        }
                                                    >
                                                        <div
                                                            className={
                                                        ...
                                                        <div className={"relative bg-white"}>
                                                            <div className={"mx-auto max-w-7xl px-8 "}>
                                                                <div
                                                                    className={
                                                                        "grid grid-cols-2 gap-y-10 gap-x-8 py-16"
                                                                    }
                                                                >
                                                                    <div
                                                                        className={
                                                                    ...
                                                                    >
                                                                        {category.featured.map((item) => (
                                                                            ...
                                                                            >
                                                                                <div
                                                                                    className={
                                                                                        "overflow-hidden rounded-lg bg-gray-100 group-hover:opacity-75"
                                                                                    }
                                                                                >
                                                                                    <LazyLoadImage
                                                                                        src={item.imageSrc}
                                ...
                                {headerData.pages.map((page) => (
                                    <Link
                                        ...
                                        key={page.name}
                                        className={
                                            "flex items-center font-medium text-gray-700 hover:text-gray-800"
                                        }
                                    >
                                        {page.name}
                                    </Link>
                        ...
                        {isLoggedIn ? (
                            <div className={'flex items-center justify-center'}>
                                <img
                                    ...
                                    alt={""}
                                    className={'h-8 text-sm font-medium text-gray-700 hover:text-gray-800 rounded-2xl'}
                                />


                                <span className="h-6 w-px mr-1" aria-hidden="true"/>
                                <div
                                    className={'h-8 text-lg font-medium text-gray-800 '}
                                >
                                    {profileInfo?.username}
                                </div>
                                <span className="h-6 w-px mr-6" aria-hidden="true"/>

                                <Link
                                    to="/profile"
                                    className="h-6 text-sm font-medium text-gray-700 hover:text-gray-800"
                                >
                                    Profile
                                </Link>
