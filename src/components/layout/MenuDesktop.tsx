                        ...
                        <Popover.Group className={'z-50 hidden lg:ml-8 lg:block lg:self-stretch'}>
                            <div className={'flex h-full space-x-8'}>
                                    ...
                                    <Popover key={category.name} className={'flex'}>
                                        {({open}) => (
                                            <>
                                                ...
                                                >
                                                    <Popover.Panel
                                                        className={'absolute inset-x-0 top-full border-t-[1px] border-gray-200 text-sm text-gray-500'}
                                                    >
                                                        <div
                                ...
                                {headerData.pages.map((page)=>(
                                    <Link to={page.href} key={page.name} className={'flex items-center font-medium text-gray-700 hover:text-gray-800'}>
                                        {page.name}
                                    </Link>
                                ))}

                                {isAdmin && (
                                    <Link to={'/product/new'} className={'flex items-center text-sm font-medium text-gray-700 hover:text-gray-800'}>
                                        New Item
                                    </Link>
                                )}
                            </div>
