...
import {NFT_BREAK_POINTS, NFT_LOADING_ARRAY} from "../../data/Home/SlideOptions";
        ...
        <section className={'mx-auto mt-12 w-full max-w-7xl py-4 md:mt-20'}>
            ...
            >
                ...
                {productData.map(({id, title, price, img})=>(
                    <SwiperSlide key={id} className="group cursor-pointer rounded-2xl transition-shadow duration-300 ease-in-out">
