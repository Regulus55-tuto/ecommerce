    ...
    <section className={"mx-auto mt-12 w-full max-w-7xl py-4 md:mt-20"}>
        <div className={'flex items-center justify-between px-6'}>
            ...
            <div className="hidden items-center justify-center sm:flex">
                <div
                    className="swiper-button image-swiper-button-prev mr-4 flex h-10 w-10 cursor-pointer items-center justify-center rounded-full border border-gray-300">
                    <ChevronLeftIcon className="h-6 w-6"/>
                </div>
                <div
                    className="swiper-button image-swiper-button-next ml-4 flex h-10 w-10 cursor-pointer items-center justify-center rounded-full border border-gray-300">
      ...
      {/*      className="group cursor-pointer rounded-2xl transition-shadow duration-300 ease-in-out"*/}
      {/*    >*/}
      {/*      <ProductCard1 title={title} price={price} img={img} />*/}
      {/*    </SwiperSlide>*/}
      {/*  ))}*/}
      {/*</Swiper>*/}
    </section>
