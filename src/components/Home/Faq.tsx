        ...
        <section className={'mx-auto my-32 w-full max-w-7xl py-4 px-6 sm:mt-44'}>
            <div className={'grid grid-cols-none grid-rows-1 gap-20 lg:grid-cols-3'}>
                <div className={'col-span-2 mx-auto w-full text-left lg:col-span-1'}>
                    <p className={'text-lg font-semibold leading-8 tracking-tight text-violet-500'}>Your
                        Questions, <span className={'text-violet-500'}>Answered.</span>
                    </p>
                    ...
                    <p className={'mt-6 text-lg leading-8 text-gray-600'}>
                        ...
                        <a href={'mailto:hakjoon62@naver.com'} className={'font-medium text-violet-500'}>
                            Contact
                        </a>{" "}
                        to us.
                    </p>
