                    ...
                    <div className={'mx-auto flex flex-col rounded-3xl bg-slate-50 py-24 lg:mx-0'}>
                        ...
                        <div className={'px-6 pt-16 md:px-0'}>
                            <div className={'text-center'}>
                                <h1 className={'m-auto text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl lg:max-w-1xl'}>
                                    <span className={'block text-violet-500 lg:inline'}>Ultra Rare</span>{" "}
                                    Galaxy-Mobile-Phone
                                </h1>
